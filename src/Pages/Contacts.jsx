...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-20 text-center text-gray-50 p-4 m-auto w-fit ">
            <div className="m-4">
                <button className="rounded p-2 bg-violet-600 p-2 text-2xl">
            ...
            {AllContacts.length == 0 && <div className="m-auto w-fit p-2 align-center text-blue-300 justify-center">
                ...
                <h1 className="text-2xl">No Contact Found Please add contact using <br /> Create Contact Button</h1>
            </div>}
