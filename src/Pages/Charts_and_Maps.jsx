...
const Dashboard = () => {
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8" >
      <h1 className="text-3xl font-bold mb-4 text-pink-300">Corona Cases Chart</h1>
      ...
      <h1 className="text-3xl font-bold mb-4 mt-4 text-blue-500">Corona Cases World Map</h1>
      <div
      ...
      >
        ...
        >
          ...
          <TileLayer
            ...
            attribution=' <a href="https://stadiamaps.com/"></a><a href="https://openmaptiles.org/"></a> <a href="http://openstreetmap.org"></a> contributors'
          />
