...
export default function Sidebar() {
    return (
        <div className="flex border-r-2 bg-gray-600">
            <div className="flex flex-col h-screen p-3 bg-white-300 shadow w-60 md:w-56 lg:w-48">
                    ...
                    <div className="flex-1">
                        <ul className="pt-2 pb-4 space-y-1 text-sm">
                            <li className="rounded-sm">
                                <Link
                                    to="/"
                                    className="flex items-center p-2 space-x-3 rounded-md font-semibold text-white"
                                >
                                    <img src={contact} />
                                    <span>Contacts</span>
                                </Link>
